...
public static class DbToolsErrors
{
    ...
    public static Err WindowsNtIntegratedSecurityIsOffAndServerUserDoesNotSpecifiedOrServerPassDoesNotSpecified => new()
    {
        ErrorCode = nameof(WindowsNtIntegratedSecurityIsOffAndServerUserDoesNotSpecifiedOrServerPassDoesNotSpecified),
        ErrorMessage = "WindowsNtIntegratedSecurity is off and serverUser does not specified or serverPass does not specified"
    };

    public static Err ServerAddressIsEmptyCannotCreateSqlServerManagementClient => new()
    {
    ...
    public static Err DatabaseProviderIsNone => new()
    {
        ErrorCode = nameof(DatabaseProviderIsNone),
        ErrorMessage = "Database Provider is None"
    };

    public static Err DatabaseConnectionNameIsNotSpecified => new()
    {
        ErrorCode = nameof(DatabaseConnectionNameIsNotSpecified),
        ErrorMessage = "databaseConnectionName is not specified"
    };

    public static Err CreateSqLiteDatabaseManagerIsNotImplemented => new()
    {
        ErrorCode = nameof(CreateSqLiteDatabaseManagerIsNotImplemented),
        ErrorMessage = "CreateSqLiteDatabaseManager Is Not Implemented"
    };

    public static Err CreateOleDatabaseManagerIsNotImplemented => new()
    {
        ErrorCode = nameof(CreateOleDatabaseManagerIsNotImplemented),
        ErrorMessage = "CreateOleDatabaseManager Is Not Implemented"
    };

    public static Err ApiClientNameIsNotSpecifiedCannotCreateDatabaseApiClient => new()
    {
